...
| Share-group consumer | Caller-ordered multi-topic subscription, Share heartbeat membership, broker-local acquisition sessions, delivery counts, linear batches, and explicit Accept, Release, or Reject acknowledgement | Configured exact two-topic assignment and record acquisition, lifecycle, record fidelity, mixed release/reject, batch drop, maximum-record fetch, membership ownership, close uncertainty, leader recovery, and session recovery in applicable Kafka 4.x cells |
...
`c1fcd9f06820ea4e1762b47d5cc46b3dfa19b135` defines the following gating cells.
