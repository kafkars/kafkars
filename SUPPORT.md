...
`e54f80e064d1ace5f874ae7a675d31ef5ff1e140` defines the following gating cells.
...
Its controlled network-proxy cell now requires exact post-cut single-record and
complete-batch producer commands plus exact progress from the same directly
