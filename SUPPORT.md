...
| Classic group consumer | Dynamic and static membership, caller-ordered multi-topic subscription, range and cooperative-sticky assignment, assignment events, fetch, checkpoint commit, seek, and close paths | Configured round-trip with broker-reported cooperative-sticky selection, exact two-topic assignment and record delivery, seek, pause/resume, offset reset, read-committed, shutdown, static-member retention and administrative removal, record fidelity, membership ownership, offset resume, broker restart, and session recovery |
...
`756a4517a71bb74598c573b8de67b3e7e9771187` defines the following gating cells.
