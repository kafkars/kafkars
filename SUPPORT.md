...
| Classic group consumer | Dynamic and static membership, assignment events, fetch, checkpoint commit, seek, and close paths | Configured round-trip, seek, pause/resume, offset reset, read-committed, shutdown, static-member retention and administrative removal, record fidelity, membership ownership, offset resume, broker restart, and session recovery |
...
`9459f41dc089e0ea8864692f48311666536c67d4` defines the following gating cells.
