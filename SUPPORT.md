...
`3429f5a4981bac550d5f853bfe9f530d49e38fea` defines the following gating cells.
...
post-cut progress from the same classic and KIP-848 group handles on independent
public clients. Proxy effect observations and client completions remain separate
evidence.
