...
`c7572e2bc899a3db50b5d2402ddd11643e26ce02` defines the following gating cells.
...
Its broker-role cell also requires exact directly assigned, classic-group, and
KIP-848 group Fetch progress from each disrupted topic-partition after an
independently observed replacement election and before the original partition
leader is restored. Producer acknowledgement alone cannot satisfy those
consumer contracts.
