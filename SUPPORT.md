...
`8dc1e99b09f48482bbbf6fc899fadc15edbd99df` defines the following gating cells.
...
complete-batch, and transactional-batch producer commands plus exact progress
from the same directly assigned, classic, KIP-848, and Share handles on
independent public clients. Proxy effect observations and client completions
