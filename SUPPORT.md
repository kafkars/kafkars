...
`c4a9f4f066a7b830d7b02500c266da426f7f13bc` defines the following gating cells.
...
Its controlled network-proxy cell now requires producer reconnection plus exact
post-cut progress from the same directly assigned, classic, KIP-848, and Share
handles on independent public clients. Proxy effect observations and client
completions remain separate evidence.
