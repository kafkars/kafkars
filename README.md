...
The broker-role cell independently identifies and stops the exact partition
leader, then requires the same directly assigned consumer to return an exact
new record after replacement election and before original-owner restoration.
