...
use super::{
    ...
    result::{
        ...
        translate_observer_error, translate_partition_error_parts,
    },
};
...
#[test]
fn partition_error_keeps_exact_signed_code_diagnostic_and_truncation() {
    let error = translate_partition_error_parts(-731, Some("bounded"), true);
