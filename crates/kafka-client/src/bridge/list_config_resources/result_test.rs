//! Configuration-resource category, delivery, and broker-code tests.

use crate::{ConfigResourceType, DeliveryStatus, ErrorKind};
...
use super::{
    ...
    result::{
        ...
        translate_failure_parts, translate_observer_error, translate_resource_parts,
    },
};
...
#[test]
fn resource_translation_preserves_future_positive_type_and_name() {
    let resource = translate_resource_parts(64, "future-resource".to_owned());

    assert_eq!(resource.resource_type(), ConfigResourceType::from_raw(64));
