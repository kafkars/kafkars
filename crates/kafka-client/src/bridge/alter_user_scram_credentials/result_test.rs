//! SCRAM alteration error and delivery translation tests.
...
fn admission_categories_are_exhaustive_and_definitely_unsent() {
    for (kind, expected) in [
        ...
        (AdmissionErrorKind::Preparation, ErrorKind::Internal),
...
#[test]
fn per_user_broker_details_and_delivery_are_exact() {
    let error = translate_broker_parts(-731, Some("denied"), true);
