//! Partition-transaction abort category, code, and delivery translation tests.
...
#[test]
fn broker_rejection_preserves_the_exact_signed_code_and_certainty() {
    let error = translate_broker_error_code(-31_999);
