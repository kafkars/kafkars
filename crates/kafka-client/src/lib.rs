...
pub use admin::{
    ...
    ConsumerGroupListing, ConsumerGroupMember, ConsumerGroupMemberDetails,
    ConsumerGroupMemberRemoval, ConsumerGroupOffset, ConsumerGroupOffsetAlteration,
    ConsumerGroupTopicPartitions, ConsumerProtocolGroupDetails, ConsumerProtocolMemberDetails,
    CreateAclBrokerError, CreateAclOutcome, CreateAclResult, CreateAcls, CreateAclsBuilder,
    CreateAclsResult, CreatePartitions, CreatePartitionsBuilder, CreateTopics, CreateTopicsBuilder,
    ...
    DeleteConsumerGroupOffsetsResult, DeleteConsumerGroups, DeleteConsumerGroupsBuilder,
    DeleteConsumerGroupsResult, DeleteRecords, DeleteRecordsBuilder, DeleteRecordsResult,
    DeleteRecordsResultInfo, DeleteRecordsTarget, DeleteTopics, DeleteTopicsBuilder, DescribeAcls,
    DescribeAclsBuilder, DescribeAclsResult, DescribeCluster, DescribeClusterBuilder,
    DescribeConfigs, DescribeConfigsBuilder, DescribeConfigsResult, DescribeConsumerGroups,
    DescribeConsumerGroupsBuilder, DescribeConsumerGroupsResult, DescribeLogDirs,
    DescribeLogDirsBuilder, DescribeLogDirsResult, DescribeTopics, DescribeTopicsBuilder,
    ElectLeaders, ElectLeadersBuilder, ElectLeadersResult, IncrementalAlterConfigs,
    IncrementalAlterConfigsBuilder, IncrementalAlterConfigsResult, LeaderElectionTarget,
    LeaderElectionType, ListConsumerGroupOffsets, ListConsumerGroupOffsetsBuilder,
    ListConsumerGroupOffsetsResult, ListConsumerGroups, ListConsumerGroupsBrokerError,
    ListConsumerGroupsBuilder, ListConsumerGroupsResult, ListOffsets, ListOffsetsBuilder,
    ListOffsetsQuery, ListOffsetsResult, ListOffsetsResultInfo, ListPartitionReassignments,
    ListPartitionReassignmentsBuilder, ListPartitionReassignmentsResult, ListTopics,
    ListTopicsBuilder, LogDirDescription, LogDirReplica, NewPartitions, NewTopic, OffsetSpec,
    PartitionReassignment, PartitionReassignmentChange, RemoveConsumerGroupMembers,
    RemoveConsumerGroupMembersBuilder, RemoveConsumerGroupMembersResult, ReplicaLogDirAssignment,
    ResourcePattern, TopicConfigAlterations, TopicConfigQuery, TopicDescription,
    TopicPartitionDescription, TopicPartitionReplica,
};
