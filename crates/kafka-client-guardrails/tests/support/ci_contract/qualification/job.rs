...
const TESTLAB: &str = "kafkars/testlab@adf305587fac071fc7b385848952134cd21578ed";
const TESTLAB_REF: &str = "adf305587fac071fc7b385848952134cd21578ed";
const RELEASE: &str = "kafkars/testlab/.github/workflows/qualification-release.yml@adf305587fac071fc7b385848952134cd21578ed";
