...
macro_rules! engine {
    ...
    ("host/terminal/recovery.rs") => {
        "crates/kafka-client-engine/src/admin/describe_delegation_tokens/host/terminal/recovery.rs"
    };
    ("host/terminal/recovery_test.rs") => {
        "crates/kafka-client-engine/src/admin/describe_delegation_tokens/host/terminal/recovery_test.rs"
    };
    ("host/terminal/test_support.rs") => {
        "crates/kafka-client-engine/src/admin/describe_delegation_tokens/host/terminal/test_support.rs"
    };
    ("host_test.rs") => {
