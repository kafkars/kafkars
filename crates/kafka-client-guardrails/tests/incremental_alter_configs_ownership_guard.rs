//! Registration and negative evidence for incremental configuration ownership.
...
const MACHINE: &str = "IncrementalAlterConfigsMachine";
const MACHINE_PATH: &str = "crates/kafka-client-core/src/admin/alter_configs/machine.rs";
const TRANSITION_PATH: &str = "crates/kafka-client-core/src/admin/alter_configs/transition.rs";

#[test]
fn incremental_alter_configs_owner_is_registered_at_its_exact_core_modules() {
...
#[test]
fn fixture_rejects_incremental_state_mutation_outside_its_owner() {
    let (root, files) = fixture_files("incremental_alter_configs_ownership");
...
#[test]
fn fixture_rejects_clone_and_copy_for_the_incremental_owner() {
    let (root, files) = fixture_files("incremental_alter_configs_ownership");
