...
fn testlab_pin_verdict_and_evidence_bypasses_are_rejected() {
    ...
    for (broken, expected) in [
        (
            workflow.replace(
                "kafkars/testlab@76db0e2452d674bf232a13ef51a29bbfed0863b1",
        ...
        (
            workflow.replacen(
                "uses: kafkars/testlab@76db0e2452d674bf232a13ef51a29bbfed0863b1",
...
fn release_workflow_cannot_change_pin_skip_aggregation_or_swallow_failures() {
    let workflow = read(&workspace_root().join(".github/workflows/qualification.yml"));
    for broken in [
        workflow.replace("testlab-ref: 76db0e2452d674bf232a13ef51a29bbfed0863b1", "testlab-ref: main"),
        ...
        workflow.replace("qualification-release.yml@76db0e2452d674bf232a13ef51a29bbfed0863b1", "qualification-release.yml@main"),
