...
macro_rules! facade {
    ("builder.rs") => {
        "crates/kafkars/src/admin/expire_delegation_token/builder.rs"
    };
    ("operation.rs") => {
        "crates/kafkars/src/admin/expire_delegation_token/operation.rs"
    };
    ("operation_test.rs") => {
        "crates/kafkars/src/admin/expire_delegation_token/operation_test.rs"
    };
    ("result.rs") => {
        "crates/kafkars/src/admin/expire_delegation_token/result.rs"
    };
    ("result_test.rs") => {
        "crates/kafkars/src/admin/expire_delegation_token/result_test.rs"
    };
}
macro_rules! bridge {
    ("operation.rs") => {
        "crates/kafkars/src/bridge/expire_delegation_token/operation.rs"
    };
    ("request.rs") => {
        "crates/kafkars/src/bridge/expire_delegation_token/request.rs"
    };
    ("request_test.rs") => {
        "crates/kafkars/src/bridge/expire_delegation_token/request_test.rs"
    };
    ("result.rs") => {
        "crates/kafkars/src/bridge/expire_delegation_token/result.rs"
    };
    ("result_test.rs") => {
        "crates/kafkars/src/bridge/expire_delegation_token/result_test.rs"
    };
}
