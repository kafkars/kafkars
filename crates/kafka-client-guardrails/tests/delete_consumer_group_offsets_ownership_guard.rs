//! Registration and negative evidence for group-offset deletion ownership.
...
const MACHINE: &str = "DeleteConsumerGroupOffsetsMachine";
const MACHINE_PATH: &str = "crates/kafka-client-core/src/admin/group_offset_delete/machine.rs";
const TRANSITION_PATH: &str =
    "crates/kafka-client-core/src/admin/group_offset_delete/transition.rs";

#[test]
fn group_offset_deletion_owner_is_registered_at_its_exact_core_modules() {
...
#[test]
fn fixture_rejects_group_offset_deletion_state_mutation_outside_its_owner() {
    let (root, files) = fixture_files("delete_consumer_group_offsets_ownership");
...
#[test]
fn fixture_rejects_clone_and_copy_for_the_group_offset_deletion_owner() {
    let (root, files) = fixture_files("delete_consumer_group_offsets_ownership");
