//! Curated bounded mailbox pressure and rejection counters from the driver.

use crate::driver::owner::observation::DriverMailboxMetrics;

/// Current bounded driver mailbox pressure and cumulative rejection totals.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct EngineMailboxMetrics(DriverMailboxMetrics);

impl EngineMailboxMetrics {
    pub(super) const fn from_driver(inner: DriverMailboxMetrics) -> Self {
        Self(inner)
    }
