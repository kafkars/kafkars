//! Hosted group-delivery fixture for public batch ownership tests.
...
pub(crate) struct GroupBatchFixture {
    pub(crate) owner: GroupConsumerShardOwner,
    pub(crate) handle: GroupConsumerHandle,
    pub(crate) group_id: GroupId,
}

impl GroupBatchFixture {
