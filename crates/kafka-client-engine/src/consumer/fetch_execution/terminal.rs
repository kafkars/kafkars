...
use kafka_client_core::{AssignedConsumerInput, FetchFailure, FetchFence, NextFetchOffset};

use crate::{
    driver::{FetchTerminal, PartitionFetchRequest, classify_fetch_request_error},
    protocol::fetch::{
        FetchSessionUpdate, classify_fetch_outcome_failure, fetch_session_requires_reestablishment,
...
use super::{
    ...
    terminal_fact::{core_outcome_failure, staged_fact},
