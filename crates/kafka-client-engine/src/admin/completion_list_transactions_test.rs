//! API-key 66 publication and closed-capacity evidence for the shared notifier.

use kafka_client_core::{AdminListTransactionsBatch, AdminListTransactionsTerminal};
...
#[test]
fn shared_worker_publishes_list_transactions_off_reactor() {
    ...
    exercise_terminal(
        ports.list_transactions,
        AdminListTransactionsTerminal::Listed(AdminListTransactionsBatch::new(
            0,
            Vec::new(),
            Vec::new(),
            Vec::new(),
...
#[test]
fn shared_capacity_includes_the_list_transactions_owner() {
    assert_eq!(
