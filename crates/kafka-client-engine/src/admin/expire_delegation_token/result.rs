//! Complete generated-free successful result values for token expiration.

/// Successful token expiration and Kafka's throttle observation.
...
impl ExpireDelegationTokenResult {
    ...
    /// Returns the token expiry epoch timestamp after expiration.
