//! Stable generated-free terminals for Admin `DescribeFeatures`.
...
pub enum DescribeFeaturesDeliveryStatus {
...
pub struct DescribeFeaturesFailure {
    pub(super) kind: DescribeFeaturesFailureKind,
    pub(super) delivery: DescribeFeaturesDeliveryStatus,
}
...
impl DescribeFeaturesFailure {
    ...
    pub const fn delivery(self) -> DescribeFeaturesDeliveryStatus {
        self.delivery
    }
}
...
pub enum DescribeFeaturesOutcome {
    /// Kafka returned bounded canonical feature metadata.
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum DescribeFeaturesObserverError {
...
impl fmt::Display for DescribeFeaturesObserverError {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        formatter.write_str(match self {
            Self::AlreadyObserved => "Admin DescribeFeatures result was already observed",
            Self::Stale => "Admin DescribeFeatures observer is stale",
        })
    }
}

impl std::error::Error for DescribeFeaturesObserverError {}
