...
use kafka_client_core::{
    ClusterDescription, CreateTopicsTerminal, DeleteTopicsTerminal, DescribeClusterTerminal,
};
...
fn one_worker_publishes_every_concrete_admin_terminal_off_reactor() {
    ...
    for wake in [&create_wake, &delete_wake, &describe_wake] {
