...
pub(super) fn delete_consumer_group_offsets_host()
-> (DeleteConsumerGroupOffsetsHost, AdminCompletionNotifier) {
    let (notifier, ports) = completion_owner();
    (
...
pub(super) fn alter_consumer_group_offsets_host()
-> (AlterConsumerGroupOffsetsHost, AdminCompletionNotifier) {
    let (notifier, ports) = completion_owner();
    (
...
pub(super) fn delete_records_host() -> (DeleteRecordsHost, AdminCompletionNotifier) {
    let (notifier, ports) = completion_owner();
    (DeleteRecordsHost::new(ports.delete_records), notifier)
}
