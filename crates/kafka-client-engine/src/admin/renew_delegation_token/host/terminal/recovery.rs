...
impl RenewDelegationTokenHost {
    ...
    fn retain_recovered_call(&mut self, index: usize) -> Result<(), RenewDelegationTokenHostError> {
    ...
    pub(super) fn settle_recovered_transport(
        ...
        let transition =
            self.operations[index]
                .machine
                .apply(RenewDelegationTokenInput::TransportFailed {
        ...
        let terminal = match transition.into_effect() {
            ...
            _ => return Err(RenewDelegationTokenHostError::MissingTerminal),
        };
