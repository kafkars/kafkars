//! API-key 74 typed publication evidence for the shared admin notifier.

use kafka_client_core::{
    ListClientMetricsResourcesBrokerError, ListClientMetricsResourcesTerminal,
};
...
#[test]
fn shared_worker_publishes_list_client_metrics_resources_off_reactor() {
    ...
    exercise_terminal(
        ports.list_client_metrics_resources,
        ListClientMetricsResourcesTerminal::BrokerRejected(
            ListClientMetricsResourcesBrokerError::new(0, core::num::NonZeroI16::MIN),
        ),
        worker,
    );
    let join = notifier
...
#[test]
fn shared_capacity_includes_the_list_client_metrics_resources_owner() {
    assert_eq!(
