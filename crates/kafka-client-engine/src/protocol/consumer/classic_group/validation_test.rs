...
use super::validation::{
    ...
    MAX_TOPICS, SYNC_MAX_VERSION, SYNC_MIN_VERSION, inner_decode_limits, valid_join_version,
    valid_sync_version,
};

#[test]
fn outer_windows_match_the_driver_dynamic_membership_contract() {
