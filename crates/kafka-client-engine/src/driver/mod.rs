...
pub(crate) use rpc::{
    ...
    DescribeConsumerGroupsCall, DescribeConsumerGroupsDriverFailureKind,
    DescribeConsumerGroupsTerminal, DescribeConsumerGroupsTerminalFact, DescribeLogDirsCall,
