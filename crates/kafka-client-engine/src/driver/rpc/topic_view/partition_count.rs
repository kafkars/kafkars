//! Exact logical-partition-count adapter over one immutable driver topic view.

use std::{error::Error, fmt, time::Instant};

use kafka_driver::{
    Call, KafkaTopicId, RouteFailureToken, SubmitError, TopicName, TopicNameError, TopicView,
    TopicViewError,
};
