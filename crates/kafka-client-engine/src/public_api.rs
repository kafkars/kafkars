...
pub use crate::consumer::{
    ...
    GroupConsumerDormantReleaseError, GroupConsumerDormantReleaseErrorKind, GroupConsumerEvent,
    GroupConsumerHandle, GroupConsumerHeader, GroupConsumerMetadata,
    GroupConsumerMissingOffsetPolicy, GroupConsumerNextEvent, GroupConsumerNextEventError,
    GroupConsumerNextEventErrorKind, GroupConsumerPositionFailureKind, GroupConsumerRecord,
    GroupConsumerRecords, GroupConsumerRecv, GroupConsumerRecvError, GroupConsumerRecvErrorKind,
    GroupConsumerRegistration, GroupConsumerRegistrationError, GroupConsumerRegistrationErrorKind,
    GroupConsumerRevocationAcknowledgeError, GroupConsumerRevocationAcknowledgeErrorKind,
    GroupConsumerRevocationControl, GroupConsumerStartAccepted, GroupConsumerStartCapture,
    GroupConsumerStartError, GroupConsumerStartErrorKind, GroupConsumerState,
    GroupConsumerStateError, GroupConsumerStateErrorKind, GroupConsumerTryTakeBatchError,
