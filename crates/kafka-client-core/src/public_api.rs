...
pub use crate::consumer::{
    ...
    ClassicSubscriptionError, DeliveryOwnership, FetchFailure, FetchFence, FetchOwnership,
    FetchRecords, FetchRevision, FetchThrottleFailure, GroupAssignmentPartition, GroupCheckpoint,
    GroupCheckpointEntry, GroupCheckpointEntryError, GroupCheckpointError, GroupId,
    GroupOffsetCommitAdmission, GroupOffsetCommitAdmissionError,
