...
pub use crate::consumer::{
    ...
    ShareAcknowledgementBuildError, ShareAcknowledgementBuildErrorKind, ShareAcquiredOffsets,
    ShareAcquiredRange, ShareAcquiredRangeError, ShareAcquisition, ShareAcquisitionAdmissionError,
    ...
    ShareAcquisitionPolicyError, ShareAcquisitionRelease, ShareDeliveryCount, ShareDisposition,
    ...
    ShareRecordDecision, ShareTopicUuid,
};
