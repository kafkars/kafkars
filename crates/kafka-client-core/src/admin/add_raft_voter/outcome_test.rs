//! Successful and exact voter-addition rejection value scenarios.
...
use super::{
    AddRaftVoterBrokerError, AddRaftVoterFailure, AddRaftVoterFailureKind, AddRaftVoterSuccess,
};

#[test]
fn success_preserves_nonnegative_throttle_observation() {
    assert_eq!(AddRaftVoterSuccess::new(17).throttle_time_ms(), 17);
}
...
fn mechanism_failure_preserves_kind_and_authoritative_delivery() {
    let failure =
        AddRaftVoterFailure::new(AddRaftVoterFailureKind::Transport, DeliveryStatus::NotSent);
