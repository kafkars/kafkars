//! Exact API-40 rejection, mechanism failure, and terminal decision.

use core::num::NonZeroI16;

use crate::DeliveryStatus;

use super::ExpireDelegationTokenSuccess;

/// Exact top-level API-40 broker rejection.
...
/// Whole-operation failure outside an exact API-40 broker rejection.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
/// Exactly one terminal decision for Admin `ExpireDelegationToken`.
#[derive(Debug, Eq, PartialEq)]
pub enum ExpireDelegationTokenTerminal {
    /// Kafka accepted expiration and returned the resulting expiry timestamp.
    Expired(ExpireDelegationTokenSuccess),
