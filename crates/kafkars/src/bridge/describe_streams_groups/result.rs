...
use crate::{
    ...
    admin::DescribeStreamsGroupsResult,
    bridge::describe_streams_group::result::{
...
use super::{
    ...
    operation::AdminDescribeStreamsGroupsResult,
};

pub(super) fn translate_admission(error: AdmissionError) -> KafkaError {
    crate::bridge::describe_streams_group::result::translate_admission_error(error)
}

pub(super) fn translate_observation(
    result: Result<Outcome, ObserverError>,
) -> AdminDescribeStreamsGroupsResult {
    match result {
        Ok(Outcome::Batch(batch)) => {
            ...
            let entries = outcomes
                ...
                .collect();
            Ok(DescribeStreamsGroupsResult::new(
