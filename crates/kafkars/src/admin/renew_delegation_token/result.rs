//! Successful delegation-token renewal facts.

use std::time::Duration;

/// Kafka throttle and the renewed token's absolute expiry timestamp.
...
impl RenewDelegationTokenResult {
    ...
    /// Returns the renewed token's Unix-epoch expiry timestamp in milliseconds.
